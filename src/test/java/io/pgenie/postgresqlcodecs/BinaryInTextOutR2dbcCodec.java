 ...
 * {@link io.r2dbc.postgresql.codec.Codec} SPI using <b>binary format for parameter
 * encoding</b> and <b>text format for result decoding</b>.
 *
...
public class BinaryInTextOutR2dbcCodec<A> implements io.r2dbc.postgresql.codec.Codec<A> {
    ...
    public BinaryInTextOutR2dbcCodec(io.pgenie.postgresqlcodecs.codecs.Codec<A> codec, Class<A> type) {
        this.codec = codec;
        this.type = type;
    }
